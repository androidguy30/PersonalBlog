...
tags:
  ...
  - CI/CD
draft: false
heroImage: "/images/blog/expo-cng-config-plugins-hero.png"
canonicalURL: ""
---
...
## 🛠 Step 8: Use It in `app.config.ts`
...
With Expo’s CNG workflow and config plugins:

- Native setup becomes repeatable, automatic, and safe
- Your repo stays clean — no random Gradle/Xcode edits
